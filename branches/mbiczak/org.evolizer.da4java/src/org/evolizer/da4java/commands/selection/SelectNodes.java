...
/**
 * Select the list of given nodes.
 * 
 * @author pinzger
 */
public class SelectNodes extends AbstractSelectionStrategy {
     ...
     */
    public SelectNodes(AbstractGraphEditCommand command, List<Node> nodes) {
        super(command);
        fNodes = nodes;
    }
