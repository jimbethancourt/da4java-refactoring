...
/**
 * Strategy to calculate the number of static methods.
 * Only counts the static methods declared by this class.
 * 
 * @author pinzger
 */
public class FamixNumberOfStaticMethodsClassStrategy extends AbstractFamixNumberOfStaticMethodsStrategy {
