...
/**
 * Strategy to calculate the number of attributes for packages.
 * Counts all attributes of contained classes and their inner and anonymous classes.
 * 
 * @author pinzger
 */
public class FamixNumberOfAttributesPackageStrategy extends AbstractFamixNumberOfAttributesStrategy {
