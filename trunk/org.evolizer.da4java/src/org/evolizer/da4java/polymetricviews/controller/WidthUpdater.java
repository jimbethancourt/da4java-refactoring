...
/**
 * Update the width of a node realizer.
 * 
 * @author mark
 */
public class WidthUpdater extends AbstractPolymetricViewUpdater {
     ...
     */
    public WidthUpdater(String attributeToRepresent) {
    ...
    public void setDefaultRealizer(NodeRealizer realizer) {
        ((IFamixNodeRealizer) realizer).setDefaultWidth();
