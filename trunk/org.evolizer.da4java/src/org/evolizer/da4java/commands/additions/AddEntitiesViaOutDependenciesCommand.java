...
/**
 * Add entities via the outgoing dependencies of the selected entity and given type.
 * If no type is specified all types are considered.
 * 
 * @author Katja Graefenhain, Martin Pinzger
 */
public class AddEntitiesViaOutDependenciesCommand extends AbstractGraphAddCommand {
     ...
     */
    public AddEntitiesViaOutDependenciesCommand(Node node, 
    ...
    public String getDescription() {
        return "Add entities via the outgoing dependencies of the selected entity";
    }
}
