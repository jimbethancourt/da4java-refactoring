...
/**
 * Abstract Superclass of all Strategies to calculated a Fan-Out metric value
 * 
 * @author Reto Zenger, pinzger
 *
 */
public class FamixFanOutStrategy extends AbstractFamixMetricStrategy {
	
	private static final String identifier = "Fan-Out";
	private static final String description = "Calculates the number of modules that are called by the selected entity";
