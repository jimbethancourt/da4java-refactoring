...
/**
 * Activator of the FAMIX model sPlugin.
 * 
 * @author pinzger
 */
public class FamixModelPlugin extends Plugin {

    /**
     * The plug-in ID
     */
    public static final String PLUGIN_ID = "org.evolizer.model.famix";

    /**
     * The shared instance
     */
    private static FamixModelPlugin sPlugin;
     ...
     */
    public static FamixModelPlugin getDefault() {
        return sPlugin;
    }
    ...
    public static InputStream openBundledFile(String filePath) throws IOException {
        return FamixModelPlugin.getDefault().getBundle().getEntry(filePath).openStream();
    }

    /**
     * Returns the plug-in speicific logger.
     * 
