...
/**
 * Dashed white diamond shaped edge realizer.
 * 
 * @author pinzger
 */
public class DashedWhiteDiamondEdgeRealizer extends DefaultFamixEdgeRealizer {
     ...
     */
    public DashedWhiteDiamondEdgeRealizer(EdgeRealizer realizer) {
        super(realizer);
    }
    ...
    public void setLineType(int nrLowLevelEdges) {
        ...
        switch (width) {
            case 1:
                ...
                break;
            case 2:
                setLineType(LineType.DASHED_2);
                break;
            case 3:
                setLineType(LineType.DASHED_3);
                break;
            case 4:
                setLineType(LineType.DASHED_4);
                break;
            default:
                setLineType(LineType.DASHED_4);
                break;
