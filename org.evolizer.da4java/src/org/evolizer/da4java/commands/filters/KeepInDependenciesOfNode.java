...
/**
 * Keep entities which have an incoming dependency with the selected entity (i.e., node).
 * Only incoming dependencies of these entities remain in the graph.
 * 
 * @author Katja Graefenhain, Martin Pinzger
 */
public class KeepInDependenciesOfNode extends AbstractKeepDependencies {
     ...
     */
    public KeepInDependenciesOfNode(Node selectedNode, 
    ...
    public String getDescription() {
        return "Keep incoming dependencies of selected node";
    }
}
